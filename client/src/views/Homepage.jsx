  ...
  return (
    <div className="mb-10">
      ...
      <div className="flex gap-2 w-10/12 sm:max-w-7xl mx-auto justify-center my-4">
        {active === "Curso" ? (
          <Button color="primary" variant="solid" className="sm:text-[15px] text-[11px]">
            Crecimientos/cursos
          </Button>
        ) : (
          <Button
            ...
            className="sm:text-[15px] text-[11px]">
            Crecimientos / cursos
          </Button>
        )}
        {active === "Retiro" ? (
        ...
        <>
          {loading ? (
            ...
            <div className="w-full sm:max-w-7xl mx-auto">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-2 gap-4 p-3 sm:p-4 md:p-6 lg:p-8 xl:px-40 xl:py-10  sm:max-w-7xl mx-auto mr-3 ml-3">
